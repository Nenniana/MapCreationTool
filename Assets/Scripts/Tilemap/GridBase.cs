        ...
        if (showDebug)
        {
            ...
            for (int x = 0; x < gridArray.GetLength(0); x++)
            {
                for (int y = 0; y < gridArray.GetLength(1); y++)
                {
                    ...
                    Debug.DrawLine(GetWorldPosition(x, y), GetWorldPosition(x, y) + new Vector3(0, cellSizeY), Color.white, 1000000f);
                    Debug.DrawLine(GetWorldPosition(x, y), GetWorldPosition(x, y) + new Vector3(cellSizeX, 0), Color.white, 1000000f);
                }
            }
